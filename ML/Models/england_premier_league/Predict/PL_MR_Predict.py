...
if __name__ == "__main__":
    ...
    config_base_path = '/root/barnard/ML/Configs/premier_league'
    ...
    output_predictions_csv = os.path.join(prediction_metrics_dir, 'combined_predictions.csv')  # Replace with desired output path
    output_metrics_json = os.path.join(prediction_metrics_dir, 'evaluation_metrics.json')  # Path to save evaluation metrics
    output_per_team_accuracy_csv = os.path.join(prediction_metrics_dir, 'per_team_accuracy.csv' ) # Path to save per-team accuracy
    output_per_team_accuracy_plot = os.path.join(prediction_metrics_dir, 'per_team_accuracy.png')  # Path to save the plot
    ...
    try:
        metrics = evaluate_model_performance_combined(df_combined, output_metrics_json, prediction_model)
    except Exception as e:
