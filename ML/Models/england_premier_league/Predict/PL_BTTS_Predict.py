...
def evaluate_model_performance_combined(df_combined, output_metrics_path, model_name):
    ...
    """
    try:
        true_labels = df_combined['winning_team']  # This might need to be adjusted based on your target
    ...
    print(f"Recall (Binary): {recall:.2f}")
...
def compute_betting_returns(df_combined, class_to_odds_column, confidence_thresholds, stake_amounts):
    ...
    try:
        ...
        def determine_stake(row):
            ...
            predicted_class = row['Final_Predicted_BTTS']
            prob_column = ''
            if predicted_class == 0:
                prob_column = 'Prob_No_BTTS'
...
if __name__ == "__main__":
    ...
    output_predictions_csv = '/root/barnard/machine-learning/models/metrics/premier-league/combined_predictions.csv'  # Replace with desired output path
    output_metrics_json = '/root/barnard/machine-learning/models/metrics/premier-league/evaluation_metrics.json'  # Path to save evaluation metrics
    output_per_team_accuracy_csv = '/root/barnard/machine-learning/models/metrics/premier-league/per_team_accuracy.csv'  # Path to save per-team accuracy
    output_per_team_accuracy_plot = '/root/barnard/machine-learning/models/metrics/premier-league/per_team_accuracy.png'  # Path to save the plot
    ...
    # Adjust these mappings based on how odds are related to BTTS in your dataset
    # For example, you might have 'odds_no_btts' and 'odds_btts'
    ...
    required_columns = features + [
        ...
        'odds_no_btts', 'odds_btts'  # Updated odds columns for BTTS
    ]
    try:
