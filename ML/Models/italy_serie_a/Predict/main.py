...
if __name__ == "__main__":
    ...
    model_name = 'v6-taupe-glide-rs42'  # Replace with your actual model name
    model_dir = f'/root/barnard/machine-learning/trained-models/serie-a'
    new_data_csv = f'/root/barnard/machine-learning/data-sets/serie-a/predictions.csv'  # Replace with your new data CSV path
    output_predictions_csv = '/root/barnard/machine-learning/models/metrics/serie-a/combined_predictions.csv'  # Replace with desired output path
    output_metrics_json = '/root/barnard/machine-learning/models/metrics/serie-a/evaluation_metrics.json'  # Path to save evaluation metrics
    output_per_team_accuracy_csv = '/root/barnard/machine-learning/models/metrics/serie-a/per_team_accuracy.csv'  # Path to save per-team accuracy
    output_per_team_accuracy_plot = '/root/barnard/machine-learning/models/metrics/serie-a/per_team_accuracy.png'  # Path to save the plot
