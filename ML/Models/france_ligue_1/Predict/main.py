...
if __name__ == "__main__":
    ...
    model_name = 'v6-awned-loach-rs42'  # Replace with your actual model name
    model_dir = f'/root/barnard/machine-learning/trained-models/ligue-1'
    new_data_csv = f'/root/barnard/machine-learning/data-sets/ligue-1/predictions.csv'  # Replace with your new data CSV path
    output_predictions_csv = '/root/barnard/machine-learning/data-prediction/metrics/ligue-1/combined_predictions.csv'  # Replace with desired output path
    output_metrics_json = '/root/barnard/machine-learning/data-prediction/metrics/ligue-1/evaluation_metrics.json'  # Path to save evaluation metrics
    output_per_team_accuracy_csv = '/root/barnard/machine-learning/data-prediction/metrics/ligue-1/per_team_accuracy.csv'  # Path to save per-team accuracy
    output_per_team_accuracy_plot = '/root/barnard/machine-learning/data-prediction/metrics/ligue-1/per_team_accuracy.png'  # Path to save the plot
